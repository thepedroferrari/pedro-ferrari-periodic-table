...
const PeriodicTable = () => {
  ...
  return (
    <section class="periodic-table">
      ...
      <PeriodicTableElement elementKey={ElementKey.express} position="g03" />
      ...
      <PeriodicTableElement elementKey={ElementKey.agile} position="f07" />
      <PeriodicTableElement elementKey={ElementKey.scrum} position="f08" />
      ...
      <PeriodicTableElement elementKey={ElementKey.figma} position="e09" />
      ...
      {/* // SERVER */}
      <PeriodicTableElement elementKey={ElementKey.apache} position="f04" />
      <PeriodicTableElement elementKey={ElementKey.nginx} position="f05" />
      <PeriodicTableElement elementKey={ElementKey.caddy} position="f06" />
